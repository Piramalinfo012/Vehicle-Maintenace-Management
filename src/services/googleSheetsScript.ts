/**
 * This is the actual Google Apps Script (Code.gs) deployed as the live
 * backend for this app. It is shown here for reference/redeployment only -
 * the app talks to the already-deployed Web App URL configured in Settings.
 */
export function generateGoogleAppsScriptCode(): string {
  return `//Sheet ID changing is compulsory
const SPREADSHEET_ID = "1oXl0vvRQSBoz9GU4Xd9wJXQGNRxkze7ChNGorMBdhK4";
